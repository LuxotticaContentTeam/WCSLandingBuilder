...
/*browsers exclusion start*/ ClickTaleSettings.PTC.doOnlyWhen = function (toDoHandler, toCheckHandler, interval, times, failHandler) {
    ...
    setTimeout(function () { ClickTaleSettings.PTC.doOnlyWhen(toDoHandler, toCheckHandler, interval, times); }, interval);
}
...
window.ClickTaleSettings.PTC.originalPCCLocation = "P46_PID39";
...
I=function(){P()||C()||J?setTimeout(n,5):window.removeEventListener("popstate",arguments.callee,!1)},window.addEventListener("popstate",I,!1))})(V);window.ClicktaleIntegrationExperienceHandler=ua;})();
    } 
...
//Signature:YZ7LLAeUSN/a4ZpgF0/Hqw/CbfFbGzGS/pE1soVF0mmREBM5xKGmEIaXBs4DL6zO6HCl7yFnL/iGbil5dEnHYMkcv96DLX5/2TBqLIb1+2hqZSGErCaQEymxxDUb7RbkaGE32bpVVVp0JdGcOImHgxS1bhIoVqfj5+rn36wICSs=