...
},{"./utilities":10,"@babel/runtime/helpers/interopRequireDefault":1}],4:[function(require,module,exports){
"use strict";
...
},{"./utilities":10,"@babel/runtime/helpers/interopRequireDefault":1}],6:[function(require,module,exports){
"use strict";
...
var mainManager = {
  setTextOnStickyBanner: function setTextOnStickyBanner() {
    window.addEventListener("resize", function () {
      _utilities["default"].ct_video_resize();
    });
    window.addEventListener("scroll", function () {
      _utilities["default"].lazyLo();
...
},{"./controlsChoices":3,"./downloadApp":4,"./features":5,"./fourVideos":6,"./getSupport":7,"./products":9,"./utilities":10,"@babel/runtime/helpers/interopRequireDefault":1}],9:[function(require,module,exports){
"use strict";
...
var productsManager = {
  init: function init() {
    ...
    function ct_populate_category_carouselMidProducts(ct_searchTermMidProducts, ct_dataElementID) {
      ...
      var productsJsonUrl = "https://media.opsm.com/2023/10_October/RB_Supernova/LP/JSON/".concat(ct_searchTermMidProducts, ".json");
      var variantJsonUrl = "https://media.opsm.com/2023/10_October/RB_Supernova/LP/JSON/".concat(ct_searchTermMidProducts, "Variants.json");
      ...
      fetchJSON(productsJsonUrl).then(function (productsJson) {
        fetchJSON(variantJsonUrl).then(function (variantsJson) {
          ...
          for (var i = products.length - 1; i >= 0; i--) {
            ...
            ct_img.src = "https://assets.opsm.com/is/image/OPSM/" + ct_cc_upc + "__STD__shad__fr.png?imwidth=1024";
            ct_img.alt = "";
...
},{"./analytics":2}],10:[function(require,module,exports){
"use strict";
