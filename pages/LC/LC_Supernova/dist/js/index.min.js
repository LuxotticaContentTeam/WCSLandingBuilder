...
var productsManager = {
  init: function init() {
    ...
    function ct_category_swapMidProducts() {
      ...
      var storedValue = localStorage.getItem(ct_selected_category);
      if (this.classList.contains("ct_clicked")) {
        var retrievedObject = JSON.parse(storedValue);
    ...
    function ct_populate_category_carouselMidProducts(ct_searchTermMidProducts, ct_dataElementID) {
      ...
      var variantJsonUrl = "../data/".concat(ct_searchTermMidProducts, "_Variants.json");
    ...
    function ct_init() {
      ...
      var ct_searchTermMidProducts = "ct_SearchRule_CategoryCarousel__Categoria1";
