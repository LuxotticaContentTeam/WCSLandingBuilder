...
var controlsChoicesManager = {
  init: function init() {
    ...
    _utilities["default"].pauseVideoOnPrevNextSlide(".controls-choices-slider");
  }
};
var _default = controlsChoicesManager;
exports["default"] = _default;

},{"./utilities":8,"@babel/runtime/helpers/interopRequireDefault":1}],3:[function(require,module,exports){
"use strict";
...
},{"./utilities":8,"@babel/runtime/helpers/interopRequireDefault":1}],4:[function(require,module,exports){
"use strict";
...
},{"./utilities":8,"@babel/runtime/helpers/interopRequireDefault":1}],5:[function(require,module,exports){
"use strict";
...
},{"./utilities":8,"@babel/runtime/helpers/interopRequireDefault":1}],6:[function(require,module,exports){
"use strict";
...
},{"./controlsChoices":2,"./features":3,"./fourVideos":4,"./getSupport":5,"./products":7,"./utilities":8,"@babel/runtime/helpers/interopRequireDefault":1}],7:[function(require,module,exports){
"use strict";
...
var productsManager = {
  init: function init() {
    ...
    function ct_category_swapMidProducts() {
      ...
      var ct_categorySelector = document.querySelector(".ct_midProducts_carousel .ct_below_category_title");
      ...
      if (ct_selected_category == "RectangleShape") {
        ct_below_category_p.textContent = "This frame has a streamlined profile that adds a balanced look to any face shape.";
      }
      if (ct_selected_category == "SquareShape") {
        ct_below_category_p.textContent = "Add a stylish shape with proportions that offer a classic look that never goes out of style";
      }
      if (ct_selected_category == "RoundShape") {
        ct_below_category_p.textContent = "This classic frame suits all face shapes for a statement making style.";
      }
      if (ct_selected_category == "CatEyeShape") {
        ct_below_category_p.textContent = "Frames like these offer a bold shape with dramatic outer edges that are tapered and rounded.";
      }
      if (ct_selected_category == "PilotShape") {
        ct_below_category_p.textContent = "The perfect choice for retro style lovers featuring an iconic shape.";
      }
    }
    ...
    function ct_iconReplaceWhiteWithBlackMidProducts() {
      var ct_categories = document.querySelectorAll(".ct_midProducts_carousel .ct_category:not(.ct_fake_category_mob)");
      ...
      var ct_selectedImage = document.querySelector(".ct_midProducts_carousel .ct_category.ct_selected img");
    ...
    function ct_populate_category_carouselMidProducts(ct_searchTermMidProducts, ct_dataElementID) {
      ...
      fetchJSON("../data/RectangleShape.json").then(function (productsJson) {
        fetchJSON("../data/RectangleShapeVariants.json").then(function (variantsJson) {
          ...
          for (var i = products.length - 1; i >= 0; i--) {
            ...
            products[i].variants.forEach(function (variant, index) {
              if (variant) {
                ct_description.appendChild(ct_variant_name);
                ct_description.appendChild(ct_variants);
                var ct_variantEl = document.createElement("li");
                ct_variants.appendChild(ct_variantEl);
                var ct_variantBullet = document.createElement("a");
                ...
                ct_variantBullet.addEventListener("click", function (event) {
                  ...
                  var currentSlideEl = this.closest(".swiper-slide");
                  var lastActiveColorBullet = currentSlideEl.querySelector(".variant-bullet.active");
                  var currentVariantNameEl = currentSlideEl.querySelector(".ct_variant_name");
                  ...
                  var currentImg = currentSlideEl.querySelector(".ct_box>img");
                  currentImg.src = "https://assets.lenscrafters.com/is/image/LensCrafters/" + variant.upc + "__STD__shad__fr.png?imwidth=1024";
                });
              }
            });
    ...
    function ct_init() {
      ...
      $(document).on("mouseenter", ".ct_midProducts_carousel .ct_category:not(.ct_selected)", ct_hoverIconMidProducts);
      $(document).on("mouseleave", ".ct_midProducts_carousel .ct_category:not(.ct_selected)", ct_unHoverIconMidProducts);
      $(".ct_category").on("click", function () {
        ct_iconReplaceWhiteWithBlackMidProducts();
      });

      /* Populate products and create carousel */
      var ct_searchTermMidProducts = "ct_SearchRule_CategoryCarousel__RectangleShape";
...
>>>>>>> 9bcdea331c73aede3abb762152c705c1c687d686
