...
var _fourVideos = _interopRequireDefault(require("./modules/fourVideos"));
var _getSupport = _interopRequireDefault(require("./modules/getSupport"));
var _features = _interopRequireDefault(require("./modules/features"));
var _controlsChoices = _interopRequireDefault(require("./modules/controlsChoices"));
var _products = _interopRequireDefault(require("./modules/products"));
var _downloadApp = _interopRequireDefault(require("./modules/downloadApp"));
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.addEventListener("scroll", function (event) {
    _utilities["default"].lazyLoading();
  });
...
},{"./modules/analytics":3,"./modules/controlsChoices":4,"./modules/downloadApp":5,"./modules/features":6,"./modules/fourVideos":7,"./modules/getSupport":8,"./modules/products":9,"./modules/utilities":10,"@babel/runtime/helpers/interopRequireDefault":1}],3:[function(require,module,exports){
"use strict";
...
var Analytics = {
  init: function init() {
    ...
    document.querySelectorAll('[data-tracking-id]').forEach(function (elem) {
  ...
  analyticsPush: function analyticsPush(data, delay) {
...
},{"./utilities":10,"@babel/runtime/helpers/interopRequireDefault":1}],5:[function(require,module,exports){
"use strict";
...
},{"./utilities":10,"@babel/runtime/helpers/interopRequireDefault":1}],7:[function(require,module,exports){
"use strict";
...
},{"./utilities":10,"@babel/runtime/helpers/interopRequireDefault":1}],8:[function(require,module,exports){
"use strict";
...
},{"./utilities":10,"@babel/runtime/helpers/interopRequireDefault":1}],9:[function(require,module,exports){
"use strict";
...
},{"./analytics":3}],10:[function(require,module,exports){
"use strict";
...
var utilitiesManager = {
  ...
  lazyLoading: function lazyLoading() {
    ...
    var ct_entries = document.querySelectorAll('#supernovaLP .lazy-lo:not(.lazy-loaded)');
    ct_entries.forEach(function (element, i) {
      ...
      if (windowTop > element.parentNode.getBoundingClientRect().top) {
        if (element.nodeName.toLowerCase() === 'picture') {
          element.querySelectorAll('source').forEach(function (item, i) {
