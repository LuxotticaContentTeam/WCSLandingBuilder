...
var navManger = {
  ...
  setOffests: function setOffests() {
    var _this = this;
    this.menu_offset = ct_current__device !== 'D' ? document.querySelectorAll('.sgh-main-menu')[1].clientHeight : document.querySelector('.main-menu-center.navbar').clientHeight + document.querySelector('.sgh-service-menu').clientHeight;
  ...
  setClickHandler: function setClickHandler() {
    ...
    (0, _toConsumableArray2["default"])(document.querySelectorAll('.ct_nav__container ul button')).forEach(function (elem) {
      elem.addEventListener('click', function () {
        ...
        _this2.manual_click.active = true;
        _this2.manual_click.section = elem.dataset.sectionTo;
