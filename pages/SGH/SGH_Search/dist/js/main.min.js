...
window.ct_wow__search.structure = {
  ...
  refreshPositionsDebounced: (0, _utils.debounce)(function () {
    if (ct_wow__search.structure.device != 'D') {
      ...
      ct_wow__search.structure.prod_list_container.parentNode.scrollLeft = _this4.prod_list_container.parentNode.clientWidth / 4;
    }
...
window.ct_wow__search.inputManagement = {
  ...
  updateQuestionCopy: function updateQuestionCopy() {
    ...
    setTimeout(function () {
      _this10.questions.container.querySelector('h3').innerHTML = window.ct_wow__search.data.questions[_this10.progress.state - 1].question["en"];
      ...
      button.addEventListener('click', function () {
        if (!button.classList.contains('ct_active')) {
          ...
          if (_this11.progress.state < _this11.stepsCount) {
            ...
            _this11.buttons.results.classList.remove('ct_disabled');
          }
        }
      });
    });
  ...
  showResult: function showResult() {
    ...
    this.setResult();
    setTimeout(function () {
      _this12.results.container.querySelector('#ct_wow__search__results_loader').classList.remove('ct_in');
