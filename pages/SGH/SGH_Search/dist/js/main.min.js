...
window.ct_wow__search.inputManagement = {
  ...
  setButtonCopy: function setButtonCopy() {
    this.buttons.prev.querySelector('span').innerHTML = _storeInfo.storeInfo.getLang(window.ct_wow__search.data.copy.inputs.next);
    this.buttons.next.querySelector('span').innerHTML = _storeInfo.storeInfo.getLang(window.ct_wow__search.data.copy.inputs.prev);
