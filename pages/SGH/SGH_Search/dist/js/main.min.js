...
window.ct_wow__search.structure = {
  ...
  adjustProdPos: function adjustProdPos() {
    var _this4 = this;
    this.prod_list.forEach(function (prod) {
      prod.elem.style.transform = "\n      translate(\n        ".concat(_this4.placeholders.coordinates[prod.elemPos].x - prod.x, "px,\n        ").concat(_this4.placeholders.coordinates[prod.elemPos].y - prod.y, "px\n      )");
    });
  },
...
window.ct_wow__search.inputManagement = {
  ...
  showResult: function showResult() {
    ...
    this.setResult();
    setTimeout(function () {
      _this11.results.container.querySelector('#ct_wow__search__results_loader').classList.remove('ct_in');
