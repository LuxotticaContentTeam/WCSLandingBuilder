...
window.ct_wow__search.inputManagement = {
  ...
  updateQuestionCopy: function updateQuestionCopy() {
    ...
    setTimeout(function () {
      _this8.questions.container.querySelector('h3').innerHTML = window.ct_wow__search.data.questions[_this8.progress.state - 1].question["en"];
      _this8.questions.container.querySelector('h3').style.opacity = 1;
    }, 400);
  },
  buildAnswers: function buildAnswers() {
    var answers = "";
    window.ct_wow__search.data.questions.forEach(function (question, i) {
    ...
    this.answers.container.querySelectorAll('button').forEach(function (button) {
      button.addEventListener('click', function () {
        if (!button.classList.contains('ct_active')) {
          ...
          if (_this9.progress.state < _this9.stepsCount) {
