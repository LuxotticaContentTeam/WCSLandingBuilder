  ...
  buildAnswers: function buildAnswers() {
    ...
    window.ct_wow__search.data.questions.forEach(function (question, qindex) {
      ...
      question.answers.forEach(function (answer, aindex) {
        answers += "\n        <div class=\"ct_wow__search__button_wrap\">\n          <button class=\"ct_cta ct_cta__black \" data-q=\"".concat(qindex, "\" tabindex=\"-1\" data-a=\"").concat(aindex, "\">").concat(_storeInfo.storeInfo.getLang(answer), "</button>\n        </div>\n        ");
      });
      answers += "</div>";
    });
...
},{"./modules/accessibility":2,"./modules/loader":3,"./modules/storeInfo":4,"./modules/utils":5}],2:[function(require,module,exports){
"use strict";
...
},{"./storeInfo":4,"./utils":5}],4:[function(require,module,exports){
"use strict";
