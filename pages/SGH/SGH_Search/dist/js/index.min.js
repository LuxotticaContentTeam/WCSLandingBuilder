...
window.ct_wow__search_questions = {
  ...
  updateProgress: function updateProgress(dir) {
    ...
    if (dir) {
      ...
      setTimeout(function () {
        // start animation
        _this6.progress.current.classList.add('ct_animation');
    ...
    setTimeout(function () {
      ...
      _this6.progress.current.classList.remove('ct_animation');
  ...
  updateQuestionCopy: function updateQuestionCopy() {
    ...
    setTimeout(function () {
      _this7.questions.container.querySelector('h3').innerHTML = window.ct_wow__search__data_question[_this7.progress.state - 1].question["en"];
      _this7.questions.container.querySelector('h3').style.opacity = 1;
    }, 400);
  },
  ...
  answersButtonHandler: function answersButtonHandler() {
    ...
    this.answers.container.querySelectorAll('button').forEach(function (button) {
      button.addEventListener('click', function () {
        ...
        _this8.container.classList.add('ct_can_proceed');
      });
    });
  },
