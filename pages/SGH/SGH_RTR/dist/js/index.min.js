...
var ct_rtr__data = {
  ...
  libraries: [{
    ...
    callback: function callback() {
      console.log("RTR BANNER - rtr viewer loaded - ".concat(window.rtrViewer));
    }
  }, {
  ...
  window.lazyLoadInstance = new LazyLoad({
    ...
    callback_enter: function callback_enter() {
      ...
      if (!document.querySelector('.ct_rtr__container') && window.rtrViewer && window.wcs_config) {
        ...
        var checkRtrViewer = setInterval(function () {
...
function ct_rtr__init() {
  var ct_rtr__device = window.outerWidth > 768 ? 'd' : 'm';
  var ct_rtr__lang = wcs_config.locale.toLowerCase();
  var ct_rtr__lang_short = wcs_config.locale.match("^[^_]+")[0];
  var ct_rtr__baseurl = location.origin + location.pathname;
  ...
  ct_rtr__container.innerHTML = "\n    <div class=\"ct_rtr__content\">\n      <picture>\n        <source srcset=\"".concat(ct_rtr__data.data.img_sx.m, "\" media=\"(max-width: 768px)\">\n        <img class=\"ct_rtr__bg\" src=\"").concat(ct_rtr__data.data.img_sx.d, "\" alt=\"3d background\" />\n      </picture>\n      <div class=\"ct_rtr__text\">\n        <h3 class=\"ct_rtr__headline\">").concat(ct_rtr__data.labels.headline["en"], "</h3>\n        <div class=\"ct_rtr__products\"></div>\n        <div class=\"ct_rtr__titles\"></div>\n        <div class=\"ct_rtr__cta\">\n          <a href=\"").concat(ct_rtr__data.links[ct_rtr__data.data.products[0].upc][ct_rtr__lang] !== undefined ? ct_rtr__baseurl + ct_rtr__data.links[ct_rtr__data.data.products[0].upc][ct_rtr__lang] : ct_rtr__baseurl + ct_rtr__data.links[ct_rtr__data.data.products[0].upc][ct_rtr__lang_short], "\" \n          data-element-id=\"X_X_MainPlacement12_RTR-CTA0\" class=\"ct_cta ct_cta__black ct_cta__large\" data-description=\"").concat(ct_rtr__data.data.products[0].upc, "\">\n            ").concat(ct_rtr__data.labels.shop_now[ct_rtr__lang] !== undefined ? ct_rtr__data.labels.shop_now[ct_rtr__lang] : ct_rtr__data.labels.shop_now[ct_rtr__lang_short], "\n          </a>\n        </div>\n        <div class=\"ct_rtr__bottom_text\"> ").concat(ct_rtr__data.labels.bottom_text[ct_rtr__lang] !== undefined ? ct_rtr__data.labels.bottom_text[ct_rtr__lang] : ct_rtr__data.labels.bottom_text[ct_rtr__lang_short], "</div>\n      </div>\n    </div>\n    <div class=\"ct_rtr__view ct_loading ct_first\">\n      <div class=\"ct_rtr__loader\">\n        <picture>\n          <source srcset=\"").concat(ct_rtr__data.data.img_dx_loader.m, "\" media=\"(max-width: 768px)\">\n          <img class=\"ct_rtr__loader_bg\" src=\"").concat(ct_rtr__data.data.img_dx_loader.d, "\" alt=\"3d background\" />\n        </picture>\n        <div class=\"ct_rtr__loader_cube\">\n          <div class=\"cube\"><div class=\"cube__face cube__face--front show-front\"></div><div class=\"cube__face cube__face--back  show-back\"></div><div class=\"cube__face cube__face--right show-right\"></div><div class=\"cube__face cube__face--left  show-left\"></div></div>\n        </div>\n      </div>\n      <div class=\"ct_rtr__viewer\"></div>\n      <div class=\"ct_rtr__icon\">\n        ").concat(ct_rtr__data.labels.rotate[ct_rtr__lang] !== undefined ? ct_rtr__data.labels.rotate[ct_rtr__lang] : ct_rtr__data.labels.rotate[ct_rtr__lang_short], "\n        <img src=\"https://media.sunglasshut.com/2023/utility/WOW/rtr/459.svg\">\n      </div>\n      <p id=\"ct_rtr__besideMouse\">\n        ").concat(ct_rtr__data.labels.cursor[ct_rtr__lang] !== undefined ? ct_rtr__data.labels.cursor[ct_rtr__lang] : ct_rtr__data.labels.cursor[ct_rtr__lang_short], "\n      </p>\n    </div>\n  ");
  ...
  ct_rtr__data.data.products.forEach(function (product, index) {
    var ct_rtr__active_class = index === 0 ? 'ct_active' : '';
    document.querySelector('.ct_rtr__container .ct_rtr__text .ct_rtr__titles').innerHTML += "\n      <div class=\"ct_rtr__title ".concat(ct_rtr__active_class, "\" data-upc=\"").concat(product.upc, "\">\n        <span>").concat(product.brand, "</span>\n        <h2>").concat(product.name, "</h2>\n      </div>\n    ");
    document.querySelector('.ct_rtr__container .ct_rtr__text .ct_rtr__products').innerHTML += "\n      <a class=\"ct_rtr__product ".concat(ct_rtr__active_class, "\" data-upc=\"").concat(product.upc, "\" href=\"javascript:void(0)\" data-element-id=\"X_X_MainPlacement12_RTR\" data-description=\"Select ").concat(product.name, "\">\n        <img src=\"").concat(product.img, "\" alt=\"").concat(product.upc, "\">\n      </a>\n    ");
    window.lazyLoadInstance.update();
  });
  ct_rtr__init_viewer(ct_rtr__val);
  document.querySelectorAll('.ct_rtr__container .ct_rtr__products .ct_rtr__product').forEach(function (title) {
...
function ct_rtr__init_viewer(ct_rtr__val) {
  var rtrViewer = window.rtrViewer;
...
function ct_rtr__analytics_rotate() {
  tealium_data2track.push({
    'id': 'Click',
    'Tracking_Type': 'link',
    'data_element_id': 'X_X_MainPlacement12_RTR_Rotate',
    // max 25 characters
    'data_description': document.querySelector('.ct_rtr__container .ct_rtr__cta a').dataset.description,
    // max 25 characters
...
function ct_rtr__analytics_zoom() {
  tealium_data2track.push({
    'id': 'Click',
    'Tracking_Type': 'link',
    'data_element_id': 'X_X_MainPlacement12_RTR_Zoom',
    // max 25 characters
    'data_description': document.querySelector('.ct_rtr__container .ct_rtr__cta a').dataset.description,
    // max 25 characters
    'data_analytics_available_call': "1"
...
function ct_rtr__intersection() {
  ...
  var target = document.querySelector(".ct_rtr__container .ct_rtr__view");
