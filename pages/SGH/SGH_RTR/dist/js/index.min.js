...
function ct_rtr__init() {
  ...
  ct_rtr__data.data.products.forEach(function (product, index) {
    ...
    document.querySelector('.ct_rtr__container .ct_rtr__text .ct_rtr__products').innerHTML += "\n      <a class=\"ct_rtr__product ".concat(ct_rtr__active_class, "\" data-upc=\"").concat(product.upc, "\" href=\"javascript:void(0)\" data-element-id=\"X_HomePage_Placement10\" data-description=\"").concat(product.name, "\">\n        <img src=\"").concat(product.img, "\" alt=\"").concat(product.upc, "\">\n      </a>\n    ");
    window.lazyLoadInstance.update();
  });
...
function ct_rtr__analytics_rotate() {
  tealium_data2track.push({
    'id': 'Click',
    'Tracking_Type': 'link',
    'data_element_id': 'X_HomePage_Placement10_Rotate',
    // max 25 characters
...
function ct_rtr__analytics_zoom() {
  tealium_data2track.push({
    'id': 'Click',
    'Tracking_Type': 'link',
    'data_element_id': 'X_HomePage_Placement10_Zoom',
    // max 25 characters
    'data_description': document.querySelector('.ct_rtr__container .ct_rtr__cta a').dataset.description,
    // max 25 characters
    'data_analytics_available_call': "1"
