...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var headerHeight = document.querySelector('.sgh-header-top').clientHeight ? document.querySelector('.sgh-header-top').clientHeight : window.ct_current__device === 'M' ? 48 : 40;
