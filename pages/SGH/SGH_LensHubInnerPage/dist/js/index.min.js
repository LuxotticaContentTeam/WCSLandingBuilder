...
var DragImage = /*#__PURE__*/function () {
  function DragImage(clipbox, dragger, first, _draggerWidth) {
    var _this = this;
    (0, _classCallCheck2["default"])(this, DragImage);
    (0, _defineProperty2["default"])(this, "handleImgReveal", function (e) {
      e.preventDefault();
      //e.offsetX = e.offsetX || e.targetTouches[0].pageX - clipboxDimensions.left;
      if (_this.drag && e.offsetX < _this.clipboxDimensions.width && e.offsetX > 0) {
        _this.clipbox.style.cursor = "ew-resize";
        _this.dragger.style.left = e.offsetX - draggerWidth / 2 + "px";
        _this.first.style.width = e.offsetX + "px";
      }
    });
    this.drag = false;
    ...
    this.first = first;
    this.draggerWidth = _draggerWidth;
  ...
  (0, _createClass2["default"])(DragImage, [{
    key: "handleStartDrag",
...
},{"@babel/runtime/helpers/classCallCheck":1,"@babel/runtime/helpers/createClass":2,"@babel/runtime/helpers/defineProperty":3,"@babel/runtime/helpers/interopRequireDefault":4}],10:[function(require,module,exports){
"use strict";
...
var dragger = document.querySelector(".clipbox .dragger");
var first = document.querySelector(".clipbox .primary__img");
var drag = false;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  //locomotive
  window.LPlens.lsscroll = new _locomotiveScroll["default"]({
  ...
  window.LPlens.lsscroll.on("scroll", function (args) {
...
},{"./drag":9,"@babel/runtime/helpers/interopRequireDefault":4,"@babel/runtime/helpers/typeof":7,"locomotive-scroll":8}]},{},[10]);
