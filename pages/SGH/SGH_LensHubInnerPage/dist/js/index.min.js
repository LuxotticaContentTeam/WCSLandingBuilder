...
window.LPlensHub = {};
var headerHeightDesk = 95;
var headerHeightMob = 60;
var headerHeight = ct_is_mobile() ? headerHeightMob : headerHeightDesk;

// elements
var benefitsTitle = document.querySelector("#section-benefits .ct_title");
var benefitsLens = document.querySelector("#section-benefits #lens");
var benefitsItem01 = document.querySelector("#benefits .benefits-item-01");
var benefitsItem02 = document.querySelector("#benefits .benefits-item-02");
var benefitsItem03 = document.querySelector("#benefits .benefits-item-03");
var benefitsItem04 = document.querySelector("#benefits .benefits-item-04");
  ...
  window.LPlensHub.lsscroll.on("scroll", function (args) {
    ...
    if ((0, _typeof2["default"])(args.currentElements["benefits"]) === "object") {
      ...
      if (args.scroll.y + headerHeight >= args.currentElements["benefits"].top) {
        ...
        $("#lens").css({
          bottom: "calc(100vh - ".concat(headerHeight, "px - 150px)"),
          top: "auto"
        });
        if (isScrollingDown()) {
          ...
          } else benefitsItem01.classList.remove(fixed, toTop, toBottom);
    ...
    if ((0, _typeof2["default"])(args.currentElements["item-01"]) === "object") {
      if (args.currentElements["item-01"].inView) {
        ...
        $("#benefits .benefits-item-01 div").css({
          opacity: "".concat(args.currentElements["item-01"].progress)
        });
        if (args.scroll.y + headerHeight >= args.currentElements["item-01"].top) {
          if (isScrollingDown()) benefitsItem01.classList.add(fixed, toTop);
        }
    ...
    if ((0, _typeof2["default"])(args.currentElements["item-02"]) === "object") {
      if (args.currentElements["item-02"].inView) {
        $("#benefits .benefits-item-02 div").css({
          opacity: "".concat(args.currentElements["item-02"].progress)
        });
        if (args.scroll.y + headerHeight >= window.LPlensHub.lsscroll.scroll.els["item-02"].top) {
          if (isScrollingDown()) benefitsItem02.classList.add(fixed, toTop);
        }
    ...
    if ((0, _typeof2["default"])(args.currentElements["item-04"]) === "object") {
      if (args.currentElements["item-04"].inView) {
        ...
        $("#benefits .benefits-item-04 div").css({
          opacity: "".concat(args.currentElements["item-04"].progress)
        });
      }
      if (args.currentElements["item-04"].inView) {
        if (args.scroll.y + headerHeight >= window.LPlensHub.lsscroll.scroll.els["item-04"].top) {
          if (isScrollingDown()) benefitsItem04.classList.add(fixed, toTop);
        }
      }
...
var dragger = document.querySelector(".ct_clipbox .dragger");
var first = document.querySelector(".ct_clipbox .primary__img");
var drag = false;
...
var handleImgReveal = function handleImgReveal(e) {
  e.preventDefault();
  if (ct_is_mobile()) e.offsetX = e.offsetX || e.targetTouches[0].pageX - clipboxDimensions.left;
...
},{"./lazyLoad":10,"./slider":11,"./video":12,"@babel/runtime/helpers/defineProperty":3,"@babel/runtime/helpers/interopRequireDefault":4,"@babel/runtime/helpers/typeof":7,"locomotive-scroll":8}],10:[function(require,module,exports){
"use strict";
...
},{"@babel/runtime/helpers/classCallCheck":1,"@babel/runtime/helpers/createClass":2,"@babel/runtime/helpers/interopRequireDefault":4}],11:[function(require,module,exports){
"use strict";
...
},{"@babel/runtime/helpers/classCallCheck":1,"@babel/runtime/helpers/createClass":2,"@babel/runtime/helpers/interopRequireDefault":4}],12:[function(require,module,exports){
"use strict";
...
var Video = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(Video, [{
    key: "video_manager",
    value: function video_manager() {
      var _this = this;
      var videos = document.querySelectorAll('.ct_space .ct_video__container');
      videos.forEach(function (elem) {
        ...
        _this.set_video_control(elem.querySelector('.ct_video__controls'), elem.querySelector('video'));
      });
    }
  }, {
    key: "set_video_control",
    value: function set_video_control(controls, video) {
