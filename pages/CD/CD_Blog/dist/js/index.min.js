...
function ct_filter__articles(category) {
  ...
  var ct_articles = document.querySelectorAll('#ct_blog .ct_article');
  setTimeout(function () {
    ct_articles.forEach(function (article) {
...
function ct_filterd_url() {
  if (!!location.hash) {
    var ct_url_category = location.hash.replace('#', '');
    document.querySelector("#ct_blog .ct_nav__container button[data-category=\"".concat(ct_url_category, "\"]")).classList.add('ct_active');
...
function ct_nav__handler() {
  var ct_nav__button = document.querySelectorAll('.ct_nav__container button');
  ct_nav__button.forEach(function (button) {
...
function ct_load__article() {
  var ct_articles_container = document.querySelector('.ct_articles');
  var ct_dom_articles = document.querySelectorAll('#ct_blog .ct_article.ct_loading');
  var current_article;
  ct_blog_articles.forEach(function (article, i) {
    if (i < 4) {
      ...
      current_article = "\n            <div class=\"ct_article ct_loaded\" data-category=\"".concat(article.category, "\">\n                <a href=\"").concat(location.origin + location.pathname + "/" + article.url, "\" aria-label=\"").concat(article.url, "\" data-description=\"").concat(article.url, "\" data-element-id=\"X_X_Blog_CTA\">\n                    <div class=\"ct_img__container\">\n                        <picture>\n                            <source media=\"(max-width:1024px)\" srcset=\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAcAAAAFCAYAAACJmvbYAAAAAXNSR0IArs4c6QAAABNJREFUGFdj/P///38GHIBxACQBlgQT8nbCiHIAAAAASUVORK5CYII=\">\n                            <img class=\"ct_skeleton\" src=\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAABCAYAAAD0In+KAAAAAXNSR0IArs4c6QAAABBJREFUGFdj/P///38GIAAAGfgD/vZGlWAAAAAASUVORK5CYII=\" alt=\"skeleton\">\n                        </picture>\n                        <img class=\"lazy-lo ct_article_img\" data-image-src=\"").concat(!ct_is_mobile() ? article.img : article.imgmob, "\" alt=\"").concat(article.title, "\">\n                    </div>\n                    <div class=\"ct_text\">\n                        <h2 class=\"ct_font__xl ct_lh__1-5 ct_font__bold \">").concat(article.title, "</h2>\n                        <p class=\"ct_font__s ct_lh__1-5 \">").concat(article.desc, "</p>\n                        <span class=\"ct_font__bold \">Continue reading</span>\n                    </div>\n                </a>\n            </div>");
...
function nav_letter__scroll() {
  ...
  ct_nav.addEventListener('scroll', function () {
